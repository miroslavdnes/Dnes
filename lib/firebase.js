...
// ✅ Opravený bezpečný zápis len pre prehliadač
if (typeof window !== "undefined" && auth && auth.settings) {
  try {
    auth.settings.appVerificationDisabledForTesting = true;
  } catch (e) {
    console.warn("⚠️ Nepodarilo sa nastaviť appVerificationDisabledForTesting", e);
  }
}
